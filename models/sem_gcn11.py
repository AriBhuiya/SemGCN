...
from models.sem_graph_conv import SemGraphConv4
from models.graph_non_local import GraphNonLocal
from models.myarc import ModifiedTransformerEncoderLayer
...
class _GraphConv(nn.Module):
    def __init__(self, adj, input_dim, output_dim, p_dropout=None):
        ...
        self.gconv = SemGraphConv4(input_dim, output_dim, adj)
...
class SemGCN11(nn.Module):
    def __init__(self, adj, hid_dim, coords_dim=(2, 3), num_layers=4, nodes_group=None, p_dropout=None):
        ...
        for i in range(num_layers):
            _gconv_layers.append(_ResGraphConv(adj, hid_dim, hid_dim, hid_dim, p_dropout=p_dropout))
            _gconv_layers.append(ModifiedTransformerEncoderLayer(adj,
                                                                hid_dim,
                                                                num_heads = 4,
                                                                dropout = 0.1,))
        ...
        self.gconv_output = SemGraphConv4(hid_dim, coords_dim[1], adj)
