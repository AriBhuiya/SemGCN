...
from models.sem_graph_conv import SemGraphConv5
...
class _GraphConv(nn.Module):
    def __init__(self, adj, input_dim, output_dim, p_dropout=None):
        ...
        self.gconv = SemGraphConv5(input_dim, output_dim, adj)
